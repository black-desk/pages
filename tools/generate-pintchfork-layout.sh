...
SOURCE_FILE_URL="https://raw.githubusercontent.com/vector-of-bool/pitchfork/develop/data/spec.bs"
BIKESHED_URL="https://api.csswg.org/bikeshed/"

# shellcheck disable=SC2016
USAGE="$CURRENT_SOURCE_FILE_NAME

This script generates pintchfork layout html document from
$SOURCE_FILE_URL
using $BIKESHED_URL
...
function main() {
	...
	curl >../pintchfork-layout.html "$BIKESHED_URL" \
		-F url="$SOURCE_FILE_URL" \
		-F force=1
}
